...
const theater = {
  store: "건대점",
  titles: ["어벤져스", "타이타닉", "신과함께"],
  showMovieList() {
    // 일반 함수
    this.titles.forEach(function (title) {
      console.log(this); // 일반 함수의 this는 전역 객체 global을 가리킨다.
      console.log(`${this.store} : ${title}`); // undefined : 신과함께
    });
...
let tiger = new Tiger("백두산호랑이", 100);
tiger.move(1);
