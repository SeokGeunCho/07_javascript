...
// isFinite
/* 
전달 받은 인수가 정상적인 유한수인지 검사하여 유한수이면 true를 반환하고, 무한수이면 false
를 반환한다.
전달 받은 인수가 숫자가 아닌 경우 숫자로 타입 변환 후 검사를 수행하며, NaN으로 평가되는 값
이면 false를 반환한다.
*/
...
console.log(parseFloat(" 1004 ")); // 1004 - 공백 무시
...
const uri = "http://greedy.com?name=홍길동&job=student"; // URL 요청은 get 방식이다.
