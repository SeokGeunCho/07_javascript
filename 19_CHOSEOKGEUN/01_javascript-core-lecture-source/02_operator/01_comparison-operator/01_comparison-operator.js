// 비교 연산자
// 동등비교 (==, !=): 암묵적 타입변환을 통해 타입 일치 시킨 후 같은 값인지 비교교
...
console.log(`0 == '0' : ${0 == '0'}`); // ture
console.log(`0 == 'false' : ${0 == false}`); // ture
...
// null과 undefined비교
console.log(`null == undefined : ${null == undefined}`); // ture
console.log(`null === undefined : ${null === undefined}`); // false

// NaN은 자신과 일치하지 않는 유일한 값이다.
console.log(`NaN == NaN : ${NaN == NaN}`);  // false
console.log(`NaN === NaN : ${NaN === NaN}`); // false
console.log(`Number.isNaN(NaN) : ${isNaN(NaN)}`); // true
