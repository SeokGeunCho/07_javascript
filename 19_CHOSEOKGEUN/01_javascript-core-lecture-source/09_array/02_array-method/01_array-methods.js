...
const mix = idol1.concat(idol2); // idol1을 기준으로 idol2를 결합
const mix2 = idol3.concat(idol1, idol2); // idol3을 기준으로 idol1,2를 결합

console.log(`idol1 기준으로 idol2 배열을 concat : ${mix}`);
console.log(`idol3 기준으로 idol1 배열을 concat : ${mix2}`);
...
// slice(시작인덱스, 종료인덱스)
console.log(`front.slice(1, 3) : ${front.slice(1, 3)}`); // 1포함 ,3미만  1 <= x <3
